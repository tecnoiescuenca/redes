...
.rosco-GameContainer input[type="text"],
input.rosco-EdReply {
    margin: 0 0.5em;
...
.rosco-Cubierta .exeQuextIcons-Submit {
    background: url(exequextreply.svg) no-repeat;
...
a.rosco-ModeBoard:hover,
a.rosco-ModeBoardShow:hover {
    color: #333;
    border-color: #999;
...
a.rosco-ModeBoard:active,
a.rosco-ModeBoardShow:active {
    color: #000;
    border-color: #444;
}
...
.rosco-ShowAnswerDiv a {
    display: block;
    text-decoration: none !important;
}

.rosco-ShowAnswerDiv a.rosco-ModeShow {
    color: #000
}

.rosco-ShowAnswerDiv a:hover {
    text-decoration: underline;
}
...
.exeQuextIcons-RoscoRows {
    background: url(exequextrosco.svg) no-repeat;
    background-size: cover
}

.exeQuextIcons-RoscoCanvas {
    background: url(exequextroscorows.svg) no-repeat;
    background-size: cover
}

.exeQuextIcons-OneRound {
    background: url(exequextone.svg);
    background-size: cover;
}

.exeQuextIcons-TwoRounds {
    background: url(exequexttwo.svg) no-repeat;
    background-size: cover;
}
...
.rosco-GameContainer  .rosco-FullLinkImage .exeQuextIcons{
    margin: 0;
}
...
.rosco-MainContainer:fullscreen {
    background-color: white;
    height: 100vh;
    width: 100%;
    overflow: hidden;
...
div:-o-full-screen .rosco-MultimediaNeo {
    max-width: 100%;

}

div:-webkit-full-screen .rosco-MultimediaNeo {
    max-width: 100%;
}

div:-moz-full-screen .rosco-MultimediaNeo {
    max-width: 100%;
}
...
div:fullscreen .rosco-LinkArrowMinimize {
    display: none;
}